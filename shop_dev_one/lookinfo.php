...
&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info->jianjie;?></div></td>
        ...
        <table width="530" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" bgcolor="#FFEDBF">&nbsp;&nbsp;商品描述</td>
        </tr>
      </table>
      <table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
      	<tr>
      		<td>
      			<img width="520" height="830" src="<?php echo $info->tupian_one;?>">
      		</td>
      		</tr>
      		<tr>
      		<td>
      			<img width="520" height="830" src="<?php echo $info->tupian_two;?>">
      		</td>
      		</tr>
      		<tr>
      		<td>
      			<img width="520" height="830" src="<?php echo $info->tupian_three;?>">
      		</td>
      		</tr>
      	</tr>
      </table>
