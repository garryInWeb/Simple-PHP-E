  ...
  <tr>
    ...
    <td width="561" align="center" valign="top" bgcolor="#FFFFFF"><table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php
       ...
       $sql=mysqli_query($conn,"select count(*) as total from tb_shangpin where tejia=1 ");
        ...
        <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(($_GET['page'])==""){
             ...
             $sql1=mysqli_query($conn,"select * from tb_shangpin where tejia=1 order by addtime desc limit ".($page-1)*$pagesize.",$pagesize ");
